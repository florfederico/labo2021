...
switch ( Sys.info()[['sysname']],
         Windows = { directory.root  <-  "C:/Users/feder/OneDrive/Maestr?a Big Data/Laboratorio de Implementacion I/DM_EyF" },   #Windows
...
kmes_train_desde <- 202003  #Elijo entrenar desde que empezo la pandemia
