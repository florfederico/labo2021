...
karch_dataset    <- "./datasets/paquete_premium_baja3.csv.gz"
...
campos_lags  <- setdiff(  colnames(dataset) ,  c("clase_ternaria_nueva","clase01", "numero_de_cliente","foto_mes", campos_malos) )
...
dataset[ , clase01:= ifelse( clase_ternaria_nueva=="CONTINUA", 0, 1 ) ]


#los campos que se van a utilizar
campos_buenos  <- setdiff( colnames(dataset), c("clase_ternaria_nueva","clase01", campos_malos) )
